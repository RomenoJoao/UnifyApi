/*
  ...
  - You are about to drop the column `createdAt` on the `Conteudo` table. All the data in the column will be lost.
  - Added the required column `updateAt` to the `Comentario` table without a default value. This is not possible if the table is not empty.
  - Added the required column `updateAt` to the `Conteudo` table without a default value. This is not possible if the table is not empty.
  - Added the required column `updateAt` to the `Login` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `updateAt` to the `Colecao` table without a default value. This is not possible if the table is not empty.
